...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    current_score = hogtimus_prime(current_score)
    current_score = when_pigs_fly(num_rolls, current_score)
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    def strategy_swap(player):
        if player==0:
            return strategy0
        else:
            return strategy1
    def score_swap(player):
        if player==0:
            return score0
        else:
            return score1
    ...
    while score0<goal and score1<goal:
        current_player_score = score_swap(player)
        opponent_score = score_swap(other(player))
        num_rolls = strategy_swap(player)(current_player_score,opponent_score)
        dice= select_dice(current_player_score,opponent_score,dice_swapped)
        if num_rolls<0:
            score=1
...
def check_strategy(strategy, goal=GOAL_SCORE):
    ...
    while score<=goal:
        ...
        if num_rolls==None or num_rolls <-1 or num_rolls>10:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    answer1=0
    while n>0:
        max_score=make_averaged(roll_dice,num_samples=1000)(n,dice)
        if max_score>answer1:
            answer1=max_score
            num_rolls=n
        if max_score==answer1:
           num_rolls=n 
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 10
    def swine_swap():
        if score//2==opponent_score or opponenet_score//2==score:
            swine_swap==True
        else:
            swine_swap== False
    score1=free_bacon(opponent_score)
    score1=hogtimus_prime(score1) 
    if swine_swap and score1>=margin:
        return 0
    else:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
        return num_rolls
